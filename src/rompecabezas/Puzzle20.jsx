...
export default function Puzzle20({
  ...
  useEffect(()=>{ if(solved && onWin) onWin(moves); },[solved, onWin, moves]);
  ...
  return (
    <div ref={wrapRef} className={`pzl-board ${className}`} style={{width:"100%", height:"100%"}}>
      ...
      <div className="pzl-board" style={{ width:"100%", height:"100%" }} role="grid">
        {tiles.map((t,curPos)=>{
